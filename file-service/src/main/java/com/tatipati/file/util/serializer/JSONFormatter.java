package com.tatipati.file.util.serializer;
...
//            .registerTypeAdapter(Date.class, new DateSerializer())
    ...
    public static Gson GSON_NULLABLE = new GsonBuilder()
            .serializeNulls()
//              .setPrettyPrinting()
//            .registerTypeAdapter(Date.class, new DateSerializer())
            .setExclusionStrategies(new GsonExclusionStrategy())//Added By Msh 9608
...
//            .setExclusionStrategies(new GsonExclusionStrategyLog())//Added By Msh 9608
    ...
    public static <T> String toJSON(T t, boolean isNullable) {
        if (t != null)
            return GSON_NULLABLE.toJson(t);
        return "{}";
    }
